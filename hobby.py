...
class TipcalcHandler(TemplateHandler):
    ...
    def post(self):
        ...
        values = self.handleTip(bill, service)
        self.render_template('tipcalc.html', {'values': values})

    def handleTip(self, bill, service):
        bill = float(bill)
        print(bill, service)
